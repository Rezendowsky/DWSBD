<?php
    ...
    include '../negocio/Cronograma.php';
    include '../persistencia/pPessoa.php';
    include '../negocio/Endereco.php';
    include '../negocio/Consulta.php';
    include '../persistencia/pEndereco.php';
    include '../persistencia/pCronograma.php';
    include '../persistencia/pConsulta.php';
    ...
    if (!empty($_POST)) {
        ...
        $objetoConsulta->set('idConsulta', $_POST['txtConsulta']);   
        $objetoConsulta->set('dataConsulta', $_POST['txtDataConsulta']);
        $objetoConsulta->set('motivo', $_POST['txtMotivo']);
        $objetoConsulta->set('fkCronograma', $_POST['txtFkCronograma']);
        
        
        $objetoCronograma = new Cronograma();
        $objetoCronograma->set('idCronograma', $_POST['txtIdCronograma']);
        $objetoCronograma->set('inicioHora', $_POST['txtInicioHora']);
        $objetoCronograma->set('terminoHora', $_POST['txtTerminoHora']);
        $objetoCronograma->set('data', $_POST['txtData']);
        
        if ($_POST['txtValor'] == 'gravar') {
            $objeto->incluir();
            $objetoEndereco->incluir();
            $objetoConsulta->incluir();
            $objetoCronograma->incluir();
            $objetoEndereco->incluir();
        } else if ($_POST['txtValor'] == 'editar') {
            $objeto->alterar();
            $objetoEndereco->alterar();
            $objetoCronograma->alterar();
            $objetoConsulta->alterar();
            ...
            <!--Variável escondida 'hidden' para manipulação do estado do formulário Vide: Diagrama de Estado na UML-->
                ...
                <table class="tableForm">                
                    <tr class="tableHeader">
                        <th class="tdHeader" colspan="6">Agendamento - Novo</th>
                    </tr>
                    <tr>
                        <td>Id:</td>
